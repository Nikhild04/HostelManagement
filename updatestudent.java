...
public class updatestudent extends JFrame implements ActionListener {
    ...
    updatestudent(String empId) {
        ...
        JLabel labelfname = new JLabel("Fees");
        ...
        JLabel labeladdress = new JLabel("Room No");
        ...
        JLabel labeleducation = new JLabel("Branch");
        ...
        try {
            conn c = new conn();
            String query = "select * from student2 where empid = '" + empId + "'";
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == add) {
            ...
            try {
                conn conn = new conn();
                String query = "update student2 set fname = '" + fname + "', salary = '" + salary + "', address = '"
